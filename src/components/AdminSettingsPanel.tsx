...
export const AdminSettingsPanel: React.FC<AdminSettingsPanelProps> = ({ onStartGame, onBack }) => {
  const [selectedCategories, setSelectedCategories] = useState<AssetCategory[]>(['BANKING']);
  const [hideCurrentYear, setHideCurrentYear] = useState(false);
